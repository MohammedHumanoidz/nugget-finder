...
import { ArrowLeft, Lightbulb, Pickaxe, TrendingUp } from "lucide-react";
  ...
  useEffect(() => {
    if (
      ...
      // Fallback: For authenticated users, filter from the database query if direct data not available
        ...
        const justGeneratedIdeas = allGeneratedIdeas.filter(
          (idea: GeneratedIdea) =>
        ...
        {isComplete && generatedIdeas.length > 0 && (
          <div>
                ...
                const featuredNugget: FeaturedNugget = {
                  ...
                  tags: Array.isArray(idea.tags)
                    ...
                    : idea.tags
                      ? [idea.tags]
                      : [],
                  innovationLevel: idea.confidenceScore
            ...
            <div className="mt-16 border-slate-800 border-t py-12 text-center">
              ...
              <p className="mb-6 text-slate-400">
                Generate another idea or discover thousands of validated
                business opportunities in our nugget collection
              </p>
