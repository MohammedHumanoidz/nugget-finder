  ...
  const steps = [
    {
      ...
      description: "AI monitors thousands of sources across Reddit, Twitter, Hacker News, and industry forums to identify emerging problems and trends.",
      icon: "🔍",
      delay: 0
    },
    {
      ...
      description: "Advanced algorithms analyze market timing, technical feasibility, monetization potential, and competitive landscape to score each opportunity.",
      icon: "📊",
      delay: 0.2
    },
    {
      ...
      description: "Generate comprehensive startup idea reports with execution plans, market analysis, and validation strategies ready for implementation.",
      icon: "📋",
      delay: 0.4
    }
  ];
    ...
    <section className="max-w-7xl mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          From signal to strategy—our process ensures you never miss an opportunity.
        </p>
        <motion.div
      ...
      >
        ...
        >
          95% of users report faster market validation using our AI-driven insights
        </motion.div>
      </motion.div>
    </section>
  );
