...
function Notification({ type, title, message, onDismiss }: NotificationProps) {
  ...
  return (
    <Card className={`${bgColors[type]} border mb-4`}>
  ...
  useEffect(() => {
    ...
    if (searchParams.get('upgrade') === 'success') {
      newNotifications.push({
        ...
        message: 'Your subscription has been successfully updated. You now have access to your new plan features.',
      });
      ...
      newNotifications.push({
        ...
        message: 'Your subscription upgrade was canceled. Your current plan remains unchanged.',
      });
    }
    ...
    if (searchParams.get('restored') === 'true') {
      newNotifications.push({
        ...
        message: 'Your subscription has been successfully restored and will continue at the next billing cycle.',
      });
    }
    ...
    if (searchParams.get('subscription') === 'success') {
      newNotifications.push({
        ...
        message: 'Welcome! Your subscription is now active and you have access to all premium features.',
      });
    }
