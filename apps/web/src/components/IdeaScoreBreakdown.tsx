...
export default function IdeaScoreBreakdown({ idea }: IdeaScoreBreakdownProps) {
	...
	const scoreMetrics = [
		...
		{ label: "Market Timing", value: ideaScore?.marketTimingScore || 8 },
		{
			...
			value: ideaScore?.executionDifficulty || 6,
		},
		...
		>
			...
			<div className="mb-6">
				...
				<div className="text-center">
					...
					<div className="mx-auto mt-2 h-px w-48 bg-zinc-200 dark:bg-zinc-800" />
				</div>
			</div>
			...
			<div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
				...
				<div className="space-y-3">
					...
					<div className="mt-4 text-xs text-zinc-500 dark:text-zinc-400">
						Visual Styling: Pill-shaped indicators with score inside,
