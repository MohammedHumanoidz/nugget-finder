...
export default function Navbar() {
	...
	return (
		<motion.nav
			...
			className={`sticky top-0 z-[9999] px-4 py-3 transition-all duration-300 ${
				isScrolled
					? "border-border/50 border-b bg-background/80 shadow-lg backdrop-blur-md"
					: "bg-transparent"
			}`}
		>
			<motion.div
			...
			<AnimatePresence>
				{isMobileMenuOpen && (
					<motion.div
						...
						className="absolute top-full right-0 left-0 z-50 overflow-hidden border-border border-t bg-background/95 shadow-lg backdrop-blur-md md:hidden"
						style={{ marginTop: 0 }}
					>
