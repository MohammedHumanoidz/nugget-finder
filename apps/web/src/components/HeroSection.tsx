...
import PersonalizationModal, { type PersonalizationData } from "@/components/PersonalizationModal";
...
export function HeroSection() {
  ...
  const generateIdeas = useMutation(trpc.ideas.generateOnDemand.mutationOptions({
  ...
  const generateIdeasWithPersonalization = async (personalization?: PersonalizationData) => {
          ...
          <div>
            ...
            <form onSubmit={onSubmit} className="mt-8">
              <div className="flex w-full flex-col gap-3 sm:flex-row">
                ...
                />
                <Button type="submit" className="h-12 rounded-xl px-6" disabled={isGenerating}>
                  {isGenerating ? "Generating..." : "Find Nuggets"} <ArrowRight className="w-4 h-4" />
                </Button>
              </div>
            </form>
