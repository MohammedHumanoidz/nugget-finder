...
export default function NonAuthIdeaWrapper({ ideaId }: NonAuthIdeaWrapperProps) {
  ...
  return (
    <div>
      {/* Free tier notice */}
      {getRemainingViews() === 0 && (
        <Card className="mb-4 border-amber-200 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/20 lg:mx-54">
          <CardHeader>
          ...
          <CardContent>
            <p className="text-amber-700 dark:text-amber-300 mb-4">
              Want to explore more startup opportunities? Upgrade to get unlimited access to our entire library of AI-generated ideas.
            </p>
