...
export const agentRouter = router({
  ...
  generateDailyIdea: protectedProcedure
    .input(
      z.object({
        trendCategory: z.string().optional(),
      })
  ...
  generateMultipleIdeas: protectedProcedure
  ...
  testTrendResearch: protectedProcedure.mutation(async () => {
    try {
  ...
  testProblemGap: protectedProcedure
    .input(
      z.object({
        trendTitle: z.string(),
