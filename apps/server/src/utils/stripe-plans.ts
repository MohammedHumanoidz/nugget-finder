import type { FormattedPlan, StripePlan } from "../types/subscription";
	...
	try {
		...
		for (const price of prices.data) {
			...
			plans.push({
				...
				metadata: (product as unknown as StripePlan)
					.metadata as StripePlan["metadata"],
 ...
 */
export function formatPlansForFrontend(
