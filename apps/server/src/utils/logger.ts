...
export const debugLogger = {
   ...
   */
  logPerplexityRequest: (agent: string, userPrompt: string, systemPrompt: string, params: any) => {
   ...
   */
  logContentAnalysis: (agent: string, content: string, isAlreadyJson: boolean) => {
